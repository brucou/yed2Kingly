  ...
  const transitions = [
    {
      ...
      event: "init",
      guards: [
        { predicate: guards["isNumber"], to: "n0ღNumber", action: aF["ACTION_IDENTITY"] },
        { predicate: guards["not(isNumber)"], to: "n2ღOther", action: aF["ACTION_IDENTITY"] },
      ],
    },
    { from: "n0ღNumber", event: "continue", to: "n3ღDone", action: aF["logNumber"] },
    { from: "n2ღOther", event: "continue", to: "n3ღDone", action: aF["logOther"] },
  ];
